...
public class EvaluatorService {
    ...
    public Map<String, Object> evaluate(String question, String answer, com.asknehru.interviewsimulator.interview.Interview.RoundType roundType) {
        String schemaDetails;
        if (roundType == com.asknehru.interviewsimulator.interview.Interview.RoundType.MCQ) {
            schemaDetails = "{\n" +
